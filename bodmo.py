...
reference_seed_page = "https://boodmo.com"     #Defining the seed URL (should be with a prefix, netloc and scheme and without path)
...
def get_next_link(s):
    start_link = s.find("<a class="folding_toggle" href=")
...
def web_crawl():
    ...
    while to_crawl:     #Continue Looping till the 'to_crawl' list is not empty
        urll = to_crawl.pop(0)   
       # print(urll)   #If there are elements in to_crawl then pop out the first element
